      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {isAdmin && adminData && (
          <>
            ...
            <AnalyticsStatCard title="Total Revenue" value={`₹${(adminData.revenueThisMonth || 0).toLocaleString()}`} icon="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2" />
          </>
        )}
        {isDoctor && doctorData && (
          <>
